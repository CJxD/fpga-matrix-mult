...
#define DCACHE_L3_LINE_HITCOUNT_SLOTS      256
  ...
  struct CacheLine {
    ...
    superstl::ostream& print(superstl::ostream& os, W64 tag) const;
  };

  template <int linesize>
  static inline superstl::ostream& operator <<(superstl::ostream& os, const CacheLine<linesize>& line) {
  ...
  template <int linesize>
  static inline superstl::ostream& operator <<(superstl::ostream& os, const CacheLineWithValidMask<linesize>& line) {
    return line.print(os, 0);
  }
  ...
  struct HistogramAssociativeArrayStatisticsCollector {
    ...
    static void evicted(const V& line, W64 tag) {
      ...
      if (logable(6) | FORCE_DEBUG) logfile << "[", cache_names[uniq], "] ", sim_cycle, ": evicted(", (void*)tag, "): lifetime ", lifetime, ", deadtime ", deadtime, ", hitcount ", hitcount, " (line addr ", &line, ")", superstl::endl;
    }
    ...
    static void filled(V& line, W64 tag) {
      ...
      if (logable(6) | FORCE_DEBUG) logfile << "[", cache_names[uniq], "] ", sim_cycle, ": filled(", (void*)tag, ")", " (line addr ", &line, ")", superstl::endl;
    }
    ...
    static void probed(V& line, W64 tag, int way, bool hit) { 
      if (logable(6) | FORCE_DEBUG) logfile << "[", cache_names[uniq], "] ", sim_cycle, ": probe(", (void*)tag, "): ", (hit ? "HIT" : "miss"), " way ", way, ": hitcount ", line.hitcount, ", filltime ", line.filltime, ", lasttime ", line.lasttime, " (line addr ", &line, ")", superstl::endl;
      if (hit) {
        line.hitcount++;
        line.lasttime = sim_cycle;
      }
  ...
  static inline superstl::ostream& operator <<(superstl::ostream& os, const L1Cache& cache) {
    return os;
  }
  ...
  static inline superstl::ostream& operator <<(superstl::ostream& os, const L1ICache& cache) {
    return os;
  }
  ...
  //
#ifdef ENABLE_L3_CACHE
  static inline superstl::ostream& operator <<(superstl::ostream& os, const L3CacheLine& line) {
    return line.print(os, 0);
  }
    ...
    bool insert(W64 addr, int threadid = 0) {
      ...
      if (logable(6)) {
        logfile << "TLB insertion of virt page ", (void*)(Waddr)addr, " (virt addr ", 
          ...
          ((oldtag != tag) ? "evicted old entry" : "already present"), superstl::endl;
      }
      return (oldtag != tag);
    }
  ...
  template <int tlbid, int size>
  static inline superstl::ostream& operator <<(superstl::ostream& os, const TranslationLookasideBuffer<tlbid, size>& tlb) {
    return tlb.print(os);
  }
  ...
  static inline superstl::ostream& operator <<(superstl::ostream& os, const LoadFillReq& req) {
    return req.print(os);
  }
  ...
  template <int size>
  static inline superstl::ostream& operator <<(superstl::ostream& os, const LoadFillReqQueue<size>& lfrq) {
  ...
  template <int size>
  static inline superstl::ostream& operator <<(superstl::ostream& os, const MissBuffer<size>& missbuf) {
  ...
  struct CacheHierarchy {
    ...
    superstl::ostream& print(superstl::ostream& os);
  };
#endif // STATS_ONLY
};
