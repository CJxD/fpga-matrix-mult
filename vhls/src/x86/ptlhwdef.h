...
static inline superstl::ostream& operator <<(superstl::ostream& os, const RIPVirtPhysBase& rvp) { return rvp.print(os); }
static inline superstl::ostream& operator <<(superstl::ostream& os, const RIPVirtPhys& rvp) { return rvp.print(os); }
...
superstl::stringbuf& operator <<(superstl::stringbuf& sb, const SFR& sfr);

inline superstl::ostream& operator <<(superstl::ostream& os, const SFR& sfr) {
...
superstl::ostream& operator <<(superstl::ostream& os, const IssueState& ctx);
...
superstl::ostream& operator <<(superstl::ostream& os, const UserContext& ctx);
...
inline W64 x87_fp_80bit_to_64bit(const X87Reg* x87reg) {
  ...
  asm("fldt %[mem80]\n"
      "fstpl %[mem64]\n"
      : : [mem64] "m" (reg64), [mem80] "m" (x87reg));
  return reg64;
}

inline W64 x87_fp_80bit_to_64bit_2(const long double x87reg) {
  W64 reg64;
  asm("fldt %[mem80]\n"
      "fstpl %[mem64]\n"
      : : [mem64] "m" (reg64), [mem80] "m" (x87reg));
...
struct SegmentDescriptor { 
  ...
  void setbase(W64 addr) {
    ptlsim_assert((addr >> 32) == 0); // must use FSBASE and GSBASE MSRs for 64-bit addresses
...
superstl::ostream& operator <<(superstl::ostream& os, const SegmentDescriptor& seg);
...
superstl::ostream& operator <<(superstl::ostream& os, const SegmentDescriptorCache& seg);
...
superstl::ostream& operator <<(superstl::ostream& os, const PageFaultErrorCode& pfec);
...
superstl::ostream& operator <<(superstl::ostream& os, const Level1PTE& pte);
superstl::ostream& operator <<(superstl::ostream& os, const Level2PTE& pte);
superstl::ostream& operator <<(superstl::ostream& os, const Level3PTE& pte);
superstl::ostream& operator <<(superstl::ostream& os, const Level4PTE& pte);
...
superstl::ostream& operator <<(superstl::ostream& os, const CR0& cr0);
...
superstl::ostream& operator <<(superstl::ostream& os, const CR4& cr4);
...
struct Context: public ContextBase {
  ...
  void print_tlb(superstl::ostream& os);
...
superstl::ostream& operator <<(superstl::ostream& os, const Context& ctx);
...
superstl::ostream& operator <<(superstl::ostream& os, const TransOpBase& op);
superstl::stringbuf& operator <<(superstl::stringbuf& os, const TransOpBase& op);
...
superstl::ostream& operator <<(superstl::ostream& os, const BasicBlock& bb);

//
// Printing and information
//
superstl::stringbuf& nameof(superstl::stringbuf& sbname, const TransOpBase& uop);

char* regname(int r);

superstl::stringbuf& print_value_and_flags(superstl::stringbuf& sb, W64 value, W16 flags);
...
static inline superstl::ostream& operator <<(superstl::ostream& os, const flagstring& bs) {
  for (int i = 31; i >= 0; i--) {
...
static inline superstl::stringbuf& operator <<(superstl::stringbuf& sb, const flagstring& bs) {
  for (int i = 31; i >= 0; i--) {
