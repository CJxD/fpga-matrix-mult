...
superstl::ostream& operator <<(superstl::ostream& os, const ReturnAddressStackEntry& e);
...
superstl::ostream& operator <<(superstl::ostream& os, const BranchPredictorInterface& branchpred);
