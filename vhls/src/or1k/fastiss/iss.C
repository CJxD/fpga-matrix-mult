...
/* 
 "This file was automatically generated by generate (see cpu/or32/generate.c) : do not edit. Edit execgen.c in preference to iss.C"

  hmmm. do have some manual edits now. also this file is not the execgen but its output!
*/

#define ECOUNT(X)


void orsim::orsim_sim_done(const char *m)
{
  simulator_cmd(TENOS_CMD_SIM_DONE, 0, 0, 0);
}

void orsim::exit_backdoor(const char *m)
{
#if 0
...
#else
  fprintf(stderr, "@reset :  insn #%d\n",	  runtime.cpu.reset_instructions);
  fprintf(stderr, "@exit  :  insn #%d\n",	  runtime.cpu.instructions); 
  fprintf(stderr, " diff  :  insn #%d\n",	  runtime.cpu.instructions - runtime.cpu.reset_instructions);
#endif
...
void orsim::decoder (struct iqueue_entry *current)
{
...
*/
  	    ...
  	    case NOP_COREPAUSE:  /* DJG */
	      corepause(evalsim_reg(3), cpu_state.pc);
	      break;
    ...
    /* Instruction: l.mfspr */
    {
      ...
      {         /* "l_mfspr" */
        ...
        if (cpu_state.sprs[SPR_SR] & SPR_SR_SM)
          ...
          orsim_sim_done("WARNING: trying to read SPR while SR[SUPV] is cleared.\n");
        }
      }
      #undef SET_PARAM
      #undef PARAM0
    ...
    /* Instruction: l.mtspr */
    {
      ...
      {         /* "l_mtspr" */
        ...
        if (cpu_state.sprs[SPR_SR] & SPR_SR_SM)
          ...
          orsim_sim_done("WARNING: trying to write SPR while SR[SUPV] is cleared.\n");
        }
      }
      #undef SET_PARAM
      #undef PARAM0
