...
#define NOP_PUTC        0x0004      /* Putc instruction */

#define NOP_ATOMIC      0x0006      // Atomic prefix

#define NOP_TRACE100    0x0007      // Trace in detail 100 instructions

#define NOP_COREPAUSE   0x000F      // Pause core for (r3) microseconds.

#define NOP_BUSLOCK      0x0010      // Lock BUS
#define NOP_BUSUNLOCK    0x0011      //
#define NOP_MEMFENCE     0x0012      //
