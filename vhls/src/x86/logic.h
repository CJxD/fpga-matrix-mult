...
extern superstl::ostream logfile;
...
struct FixedQueue: public superstl::array<T, SIZE> {
  ...
  int remaining() const {
    return ptlsim_max((SIZE - count) - 1, 0);
  }
  ...
  superstl::ostream& print(superstl::ostream& os) const {
    os << "Queue<", SIZE, ">: head ", head, " to tail ", tail, " (", count, " entries):", superstl::endl;
    foreach_forward((*this), i) {
      const T& entry = (*this)[i];
      os << "  slot ", intstring(i, 3), ": ", entry, superstl::endl;
    }
...
template <class T, int SIZE>
superstl::ostream& operator <<(superstl::ostream& os, FixedQueue<T, SIZE>& queue) {
...
template <class T, int size>
superstl::ostream& operator <<(superstl::ostream& os, Queue<T, size>& queue) {
  os << "Queue<", size, "]: head ", queue.head, " to tail ", queue.tail, " (", queue.count, " entries):", superstl::endl;
  foreach_forward(queue, i) {
    const T& entry = queue[i];
    os << "  ", entry, superstl::endl;
  }
...
template <typename T, int size>
struct HistoryBuffer: public superstl::array<T, size> {
  int current;
  T prevoldest;
...
template <class T, int size>
superstl::ostream& operator <<(superstl::ostream& os, HistoryBuffer<T, size>& history) {
  os << "HistoryBuffer[", size, "]: current = ", history.current, ", prevoldest = ", history.prevoldest, superstl::endl;
  for (int i = 0; i < size; i++) {
    os << "  ", history[i], superstl::endl;
  }
  return os;
}

//
// Fully Associative Superstl::Arrays
//
...
struct FullyAssociativeTags {
  ...
  superstl::stringbuf& printway(superstl::stringbuf& os, int i) const {
  ...
  superstl::stringbuf& print(superstl::stringbuf& os) const {
    foreach (i, ways) {
      printway(os, i);
      os << superstl::endl;
    }
...
template <typename T, int ways>
superstl::ostream& operator <<(superstl::ostream& os, const FullyAssociativeTags<T, ways>& tags) {
  return tags.print(os);
}

template <typename T, int ways>
superstl::stringbuf& operator <<(superstl::stringbuf& sb, const FullyAssociativeTags<T, ways>& tags) {
...
struct FullyAssociativeTagsNbitOneHot {
  ...
  superstl::ostream& printid(superstl::ostream& os, int slot) const {
...
superstl::ostream& operator <<(superstl::ostream& os, const FullyAssociativeTagsNbitOneHot<size, width, padsize>& tags) {
  return tags.print(os);
}
...
superstl::ostream& operator <<(superstl::ostream& os, const FullyAssociativeArray<T, V, ways>& assoc) {
...
struct AssociativeArray {
  ...
  superstl::ostream& print(superstl::ostream& os) const {
    os << "AssociativeArray<", setcount, " sets, ", waycount, " ways, ", linesize, "-byte lines>:", superstl::endl;
    foreach (set, setcount) {
      os << "  Set ", set, ":", superstl::endl;
      os << sets[set];
    }
    return os;
  }
...
superstl::ostream& operator <<(superstl::ostream& os, const AssociativeArray<T, V, size, ways, linesize>& aa) {
  return aa.print(os);
}
...
template <typename T, int ways>
superstl::ostream& operator <<(superstl::ostream& os, const LockableFullyAssociativeTags<T, ways>& tags) {
  return tags.print(os);
}

template <typename T, int ways>
superstl::stringbuf& operator <<(superstl::stringbuf& sb, const LockableFullyAssociativeTags<T, ways>& tags) {
  return tags.print(sb);
}
...
template <typename T, typename V, int ways>
superstl::ostream& operator <<(superstl::ostream& os, const LockableFullyAssociativeArray<T, V, ways>& assoc) {
  return assoc.print(os);
}
...
struct LockableAssociativeArray {
  ...
  superstl::ostream& print(superstl::ostream& os) const {
    os << "LockableAssociativeArray<", setcount, " sets, ", waycount, " ways, ", linesize, "-byte lines>:", superstl::endl;
    foreach (set, setcount) {
      os << "  Set ", set, ":", superstl::endl;
      os << sets[set];
    }
...
template <typename T, typename V, int size, int ways, int linesize>
superstl::ostream& operator <<(superstl::ostream& os, const LockableAssociativeArray<T, V, size, ways, linesize>& aa) {
  return aa.print(os);
}
...
template <typename T, typename V, int size, int ways, int linesize>
superstl::ostream& operator <<(superstl::ostream& os, const LockableCommitRollbackAssociativeArray<T, V, size, ways, linesize>& aa) {
  return aa.print(os);
}
...
superstl::ostream& operator <<(superstl::ostream& os, const FullyAssociativeTags8bit<size, padsize>& tags) {
  return tags.print(os);
}
...
template <int size, int padsize>
superstl::ostream& operator <<(superstl::ostream& os, const FullyAssociativeTags16bit<size, padsize>& tags) {
  return tags.print(os);
}
