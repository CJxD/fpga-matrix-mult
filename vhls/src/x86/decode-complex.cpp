...
#ifndef __x86_64__
template <> void assist_div<W64>(Context& ctx) { ptlsim_assert(false); }
template <> void assist_idiv<W64>(Context& ctx) { ptlsim_assert(false); }
#endif
...
void assist_rdtsc(Context& ctx) {
  ...
  W64 tsc = backdoor_counter_ticks(); 
#endif
  rax = LO32(tsc);
  rdx = HI32(tsc);
...
void assist_popf(Context& ctx) {
  ...
  // TransOp stp(OP_st, REG_mem, REG_ctx, REG_imm, REG_temp1, 2, ptlsim_offsetof(Context, internal_eflags)); stp.internal = 1; this << stp;
...
void assist_iret64(Context& ctx) {
  ...
  if (logable(5)) {
    logfile << "IRET64 from rip ", (void*)(Waddr)ctx.commitarf[REG_rip], ": iretctx @ ",
      (void*)(Waddr)ctx.commitarf[REG_rsp], " = ", frame,
...
bool TraceDecoder::decode_complex() {
  ...
  case 0x8c: {
    ...
    TransOp ldp(OP_ld, rdreg, REG_ctx, REG_imm, REG_zero, 1, ptlsim_offsetof(Context, seg[modrm.reg].selector)); ldp.internal = 1; this << ldp;
  ...
  case 0x9c: {
    ...
    TransOp ldp(OP_ld, REG_temp1, REG_ctx, REG_imm, REG_zero, 2, ptlsim_offsetof(Context, internal_eflags)); ldp.internal = 1; this << ldp;
  ...
  case 0xae ... 0xaf: {
    ...
    if (rep && (!first_insn_in_bb())) {
      ...
      case 0xa4: case 0xa5: {
        ...
        */
        if (rep) ptlsim_assert(rep == PFX_REPZ); // only rep is allowed for movs and rep == repz here
  ...
  case 0x120: { // mov reg,crN
    ...
    switch (modrm.reg) {
    case 0: offset = ptlsim_offsetof(Context, cr0); break;
    case 1: offset = ptlsim_offsetof(Context, cr1); break;
    case 2: offset = ptlsim_offsetof(Context, cr2); break;
    case 3: offset = ptlsim_offsetof(Context, cr3); break;
    case 4: offset = ptlsim_offsetof(Context, cr4); break;
    case 5: offset = ptlsim_offsetof(Context, cr5); break;
    case 6: offset = ptlsim_offsetof(Context, cr6); break;
    case 7: offset = ptlsim_offsetof(Context, cr7); break;
    default: MakeInvalid();
    }
  ...
  case 0x121: { // mov reg,drN
    ...
    switch (modrm.reg) {
    case 0: offset = ptlsim_offsetof(Context, dr0); break;
    case 1: offset = ptlsim_offsetof(Context, dr1); break;
    case 2: offset = ptlsim_offsetof(Context, dr2); break;
    case 3: offset = ptlsim_offsetof(Context, cr3); break;
    case 4: offset = ptlsim_offsetof(Context, dr4); break;
    case 5: offset = ptlsim_offsetof(Context, dr5); break;
    case 6: offset = ptlsim_offsetof(Context, dr6); break;
    case 7: offset = ptlsim_offsetof(Context, dr7); break;
    default: MakeInvalid();
    }
  ...
  case 0x1ae: {
    ...
    case 3: { // stmxcsr
      ...
      TransOp ldp(OP_ld, REG_temp1, REG_ctx, REG_imm, REG_zero, 1, ptlsim_offsetof(Context, mxcsr)); ldp.internal = 1; this << ldp;
  ...
  case 0x131: {
    ...
    EndOfDecode();
    extern int backdoor_counter_ticks();
    W64 sim_cycle = backdoor_counter_ticks(); 
    TransOp ldp1(OP_ld, REG_rdx, REG_zero, REG_imm, REG_zero, 3, (Waddr)sim_cycle); ldp1.internal = 1; this << ldp1;
#ifdef PTLSIM_HYPERVISOR
    TransOp ldp2(OP_ld, REG_temp0, REG_ctx, REG_imm, REG_zero, 3, ptlsim_offsetof(Context, base_tsc)); ldp2.internal = 1; this << ldp2;
