...
struct ConfigurationParserBase {
  ...
  superstl::ostream& printusage(const void* baseptr, superstl::ostream& os) const;
  superstl::ostream& print(const void* baseptr, superstl::ostream& os) const;
};
...
struct ConfigurationParser: public T {
  ...
  void add(superstl::stringbuf& field, const char* name, const char* description) {
  ...
  superstl::ostream& print(superstl::ostream& os, const T& config) {
    return options.print(&config, os);
  }

  superstl::ostream& printusage(superstl::ostream& os, const T& config) {
