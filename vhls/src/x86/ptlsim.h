...
// These are not needed for SystemC use.
//extern W64 sim_cycle;
//extern W64 unhalted_cycle_count;
//extern unsigned long int total_uops_committed, total_user_insns_committed;

void user_process_terminated(int rc);

superstl::ostream& print_user_context(superstl::ostream& os, const UserContext& ctx, int width = 4);
...
struct PTLsimMachine {
  ...
  virtual void dump_state(superstl::ostream& os);
...
void print_sysinfo(superstl::ostream& os);
...
struct PTLsimStats;
void print_banner(superstl::ostream& os, const PTLsimStats& stats, int argc = 0, char** argv = null);
...
struct PTLsimConfig {
  ...
  superstl::stringbuf core_name;

  // Logging
  bool quiet;
  superstl::stringbuf log_filename;
  W64 loglevel;
  ...
  // Statistics Database
  superstl::stringbuf stats_filename;
  W64 snapshot_cycles;
  superstl::stringbuf snapshot_now;
...
#ifdef PTLSIM_HYPERVISOR
  // Event tracing
  superstl::stringbuf event_trace_record_filename;
  bool event_trace_record_stop;
  superstl::stringbuf event_trace_replay_filename;
  ...
  W64 console_mfn;
  bool pause;
  superstl::stringbuf perfctr_name;
  bool force_native;
#endif
  ...
  // Other info
  superstl::stringbuf dumpcode_filename;
  bool dump_at_end;
  bool overshoot_and_dump;
  superstl::stringbuf bbcache_dump_filename;
...
superstl::ostream& operator <<(superstl::ostream& os, const PTLsimConfig& config);
